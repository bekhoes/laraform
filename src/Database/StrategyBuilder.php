...
class StrategyBuilder
{
    ...
    private $strategies = [
        ...
        'multilingual' => \Laraform\Database\Strategies\MultilingualStrategy::class,
        'key' => \Laraform\Database\Strategies\KeyStrategy::class,
        'group' => \Laraform\Database\Strategies\GroupStrategy::class,
        'object' => \Laraform\Database\Strategies\ObjectStrategy::class,
        'listObject' => \Laraform\Database\Strategies\ListObjectStrategy::class,
        'list' => \Laraform\Database\Strategies\ListStrategy::class,
        'array' => \Laraform\Database\Strategies\ArrayStrategy::class,
    ];
