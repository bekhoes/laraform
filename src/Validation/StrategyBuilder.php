...
class StrategyBuilder
{
    ...
    private $validators = [
        ...
        'list' => \Laraform\Validation\Strategies\ListStrategy::class,
        'object' => \Laraform\Validation\Strategies\ObjectStrategy::class,
        'multivalue' => \Laraform\Validation\Strategies\MultivalueStrategy::class,
    ];
